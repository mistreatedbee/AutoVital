...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'service_preferences'
      AND policyname = 'users_select_own_service_preferences'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'service_preferences'
      AND policyname = 'users_insert_own_service_preferences'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'service_preferences'
      AND policyname = 'users_update_own_service_preferences'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'service_preferences'
      AND policyname = 'users_delete_own_service_preferences'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      ...
      AND policyname = 'users_insert_own_onboarding_events'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'onboarding_events'
      AND policyname = 'users_select_own_onboarding_events'
  ) THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'onboarding_progress' AND policyname = 'users_select_own_onboarding') THEN
    CREATE POLICY "users_select_own_onboarding" ON onboarding_progress FOR SELECT TO authenticated USING (user_id = auth.uid());
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'onboarding_progress' AND policyname = 'users_insert_own_onboarding') THEN
    CREATE POLICY "users_insert_own_onboarding" ON onboarding_progress FOR INSERT TO authenticated WITH CHECK (user_id = auth.uid());
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'onboarding_progress' AND policyname = 'users_update_own_onboarding') THEN
    CREATE POLICY "users_update_own_onboarding" ON onboarding_progress FOR UPDATE TO authenticated USING (user_id = auth.uid());
  END IF;
END $$;
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'consents' AND policyname = 'users_select_own_consents') THEN
    CREATE POLICY "users_select_own_consents" ON consents FOR SELECT TO authenticated USING (user_id = auth.uid());
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'consents' AND policyname = 'users_insert_own_consents') THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'accounts' AND policyname = 'users_insert_own_account') THEN
    CREATE POLICY "users_insert_own_account" ON accounts FOR INSERT TO authenticated WITH CHECK (owner_user_id = auth.uid());
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'accounts' AND policyname = 'owner_update_account') THEN
    CREATE POLICY "owner_update_account" ON accounts FOR UPDATE TO authenticated USING (owner_user_id = auth.uid());
  END IF;
  ...
  END IF;
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'profiles' AND policyname = 'users_select_own_profile') THEN
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'profiles' AND policyname = 'users_update_own_profile') THEN
    CREATE POLICY "users_update_own_profile" ON profiles FOR UPDATE TO authenticated USING (user_id = auth.uid());
  END IF;
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE schemaname = 'public' AND tablename = 'platform_admins' AND policyname = 'authenticated_read_platform_admins') THEN
    CREATE POLICY "authenticated_read_platform_admins" ON platform_admins FOR SELECT TO authenticated USING (true);
  END IF;
END $$;
